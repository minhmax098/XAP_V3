...
public class TreeNodeManager : MonoBehaviour
{
    ...
    {
        GameObject childNode = Instantiate(Resources.Load(PathConfig.MODEL_ITEM_BODY_TREE) as GameObject);
    ...
    public void HandleClickNodeTree(string nameSelectedObject)
    {
        GameObject selectedObject = GameObject.Find(nameSelectedObject);
        DisplayAllChildSelectedObject(selectedObject);
        RemoveItem(nameSelectedObject);
