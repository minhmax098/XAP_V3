...
public static class MeetingConfig
{
   ...
   public static float lostConnectionMessageDuration = 4f;
   public static float toastDuration = 2f;
   public static float finishMeetingDuration = 1f;
   public static float invalidMeetingCodeToastDuration = 5f;
